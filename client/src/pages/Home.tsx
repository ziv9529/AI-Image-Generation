...
import { postModel, RenderCardPropsModel } from '../models';
import { fetchAllPostsService } from '../services/posts';
...
const Home = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const posts_data = await fetchAllPostsService();
                setAllPosts(posts_data.reverse());
            } catch (error) {
                alert(error)
            }
        };
